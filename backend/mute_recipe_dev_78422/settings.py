"""
Django settings for mute_recipe_dev_78422 project.
...
ROOT_URLCONF = 'mute_recipe_dev_78422.urls'
...
WSGI_APPLICATION = 'mute_recipe_dev_78422.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_recipe_dev_78422 API",
    "DESCRIPTION": "API documentation for mute_recipe_dev_78422 App",
    "VERSION": "v1",
}
