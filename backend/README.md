...
## Project Structure
    ...
    ├── mute_recipe_dev_78422  # Django project configurations
...
1. Clone this repo and `cd mute_recipe_dev_78422`
...
2. Clone this repo and `cd mute_recipe_dev_78422`
